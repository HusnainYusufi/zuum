...
# - If both messages are asking for arrival confirmation or if the trucker has arrived somewhere regardless of the location, they're the same
...
#     conversations_file = current_dir.parent / 'tests' / 'real_conversations' / "test_destination_conversation.json"
